...
namespace Style
{
    ...
    const juce::Colour BEATBAR_BACKGROUND_COLOUR = juce::Colour(42, 40, 34);
    const juce::Colour BEATBAR_BORDER_COLOUR = juce::Colour(0, 0, 0);
    const juce::Colour BEATBAR_LINE_COLOUR = juce::Colour(107, 104, 94);
    ...
    const juce::Colour OCTAVE_LINE_COLOUR = juce::Colour(0, 0, 0);

    const juce::Colour PLAYHEAD_POSITION_COLOUR = juce::Colour(255, 255, 255);
    ...
    const juce::Colour NOTE_DISABLED_FILL_COLOUR = juce::Colour(160, 160, 160);
    ...
    const juce::Colour NOTE_SELECTED_DISABLED_FILL_COLOUR = juce::Colour(220, 220, 220);
